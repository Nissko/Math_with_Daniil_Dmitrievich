...
namespace MathProject.Host.Infrastructure.Persistence.Providers.Migrations
{
    ...
    [Migration("20250502112305_MathProjectMigrations_0.0.1")]
    partial class MathProjectMigrations_001
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MathProject.Host.Domain.Aggregates.Subject.DirectionOfTrainingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MathProject.Host.Domain.Aggregates.Subject.LearningTopicsEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MathProject.Host.Domain.Aggregates.Subject.SubthemesOfLearningEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MathProject.Host.Domain.Aggregates.Subject.TrainingCategoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MathProject.Host.Domain.Aggregates.Subject.DirectionOfTrainingEntity", b =>
                {
                    b.HasOne("MathProject.Host.Domain.Aggregates.Subject.TrainingCategoryEntity", "TrainingCategory")
            ...
            modelBuilder.Entity("MathProject.Host.Domain.Aggregates.Subject.LearningTopicsEntity", b =>
                {
                    b.HasOne("MathProject.Host.Domain.Aggregates.Subject.DirectionOfTrainingEntity", "DirectionOfTraining")
            ...
            modelBuilder.Entity("MathProject.Host.Domain.Aggregates.Subject.SubthemesOfLearningEntity", b =>
                {
                    b.HasOne("MathProject.Host.Domain.Aggregates.Subject.LearningTopicsEntity", "LearningTopicsEntity")
